...
(function () {
  ...
  /* Тест ЭКРАНА закрыт 09.08.2026 — плечи теперь различаются ЦЕНОЙ полного
     отчёта (499/399/299), и два разных теста на одном и том же плече не
     развести: непонятно, что подействовало — вёрстка или цена. Карта пустая,
     значит renderPriceVariant всегда вернёт false и всем нарисуется наш
     базовый экран. Сами renderB/renderC оставлены: понадобится вернуть
     визуальный тест — достаточно вписать их обратно. */
  var RENDERERS = {};
