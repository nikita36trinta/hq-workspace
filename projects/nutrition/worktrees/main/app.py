...
#
# Состав — это описание САМОГО БЛЮДА, а не обещание нашего рецепта: греческий
# салат состоит из огурцов, помидоров, феты и оливок независимо от того, кто его
# готовит. Выдумывать граммовки или «наш секретный соус» здесь нельзя — рецепт
# в оплаченном плане собирает модель, и он может отличаться в деталях.
# Поэтому формулировки нейтральные и проверяемые.
PREVIEW_PICKS = {
    "breakfast": {
        ...
        "Смузи с бананом": "Банан, молоко, овсянка",
    },
    "lunch": {
        "Куриная грудка с рисом": "Курица, рис, овощи",
        "Рыба запеченная с овощами": "Белая рыба и овощи",
        "Греческий салат": "Огурцы, помидоры, фета",
        "Овощное рагу": "Кабачки, баклажаны, перец",
        "Суп-пюре из брокколи": "Брокколи, картофель, сливки",
        "Винегрет классический": "Свёкла, морковь, горошек",
    ...
    "dinner": {
        ...
        "Гречка с грибами": "Гречка, шампиньоны, лук",
        "Рис с овощами": "Рис, морковь, горошек",
        "Гриль овощи": "Кабачки, перец, баклажаны",
        "Стейк из лосося": "Лосось, лимон, травы",
        "Овощное карри": "Овощи, кокос, карри, рис",
    },
}
